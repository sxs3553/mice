#include "edit_icecream.h"

namespace Mice {

E_icecream::E_icecream(std::string name, std::string description, double cost, double price)
...
void Scoop::save(std::ostream& ost) {
    ost << "#" << std::endl << "Icecream flavor" << std::endl; // header                                                                                                                                
    ost << _name << std::endl;
    ost << _cost << std::endl;
    ost << _price << std::endl;
